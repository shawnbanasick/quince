...
describe("MobileAccessCodeScreen", () => {
  ...
  describe("Rendering", () => {
    it("should render the access code input field", () => {
      renderWithTheme(<MobileAccessCodeScreen />);
    ...
    it("should have autoCapitalize none on input field", () => {
      renderWithTheme(<MobileAccessCodeScreen />);
    ...
    it("should render form with autoComplete none", () => {
      const { container } = renderWithTheme(<MobileAccessCodeScreen />);

      const form = container.querySelector("form");
      expect(form).toHaveAttribute("autoComplete", "none");
    });
  ...
  describe("UseEffect Initialization", () => {
    ...
    it("should remove keyup event listener on unmount", () => {
      ...
      const { unmount } = renderWithTheme(<MobileAccessCodeScreen />);
      unmount();
  ...
  describe("Submit Button Props", () => {
    it("should pass correct props to LogInSubmitButton", async () => {
      const LogInSubmitButton = vi.mocked((await import("../LogInSubmitButton")).default);
